                ...
                {step === 1 && (
                  <form onSubmit={handleRequestOTP} className="space-y-6">
                    ...
                    <button
                      type="submit"
                      disabled={isLoading}
                      className="w-full py-3 px-4 bg-[#5173FB] text-white font-bold rounded-xl hover:bg-[#3a5bd9] transition-all disabled:opacity-70 flex items-center justify-center group"
                    >
                  ...
                  <form onSubmit={handleVerifyOTP} className="space-y-6">
                    ...
                    <div className="flex gap-3">
                      ...
                      <button
                        type="submit"
                        disabled={isLoading}
                        className="flex-[2] py-3 px-4 bg-[#5173FB] text-white font-bold rounded-xl hover:bg-[#3a5bd9] transition-all disabled:opacity-70 flex items-center justify-center"
                      >
                ...
                {step === 3 && (
                  <form onSubmit={handleResetPassword} className="space-y-6">
                    ...
                    <button
                      type="submit"
                      disabled={isLoading}
                      className="w-full py-3 px-4 bg-[#5173FB] text-white font-bold rounded-xl hover:bg-[#3a5bd9] transition-all disabled:opacity-70 flex items-center justify-center"
                    >
