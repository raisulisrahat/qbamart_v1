                    ...
                    <div className="lg:col-span-3">
                        ...
                        {orders?.length === 0 ? (
                            ...
                            >
                                ...
                                <Link 
                                    to="/products" 
                                    className="inline-flex items-center space-x-2 bg-[#5173FB] text-white px-6 py-2.5 rounded-lg font-medium hover:bg-[#3a5bd9] transition-colors"
                                >
                                        ...
                                        {getPageNumbers().map((page, index) => (
                                            page === '...' ? (
                                                ...
                                                <button
                                                    ...
                                                    className={`w-10 h-10 rounded-xl text-sm font-bold transition-all ${currentPage === page ? 'bg-[#5173FB] text-white shadow-lg shadow-[#5173FB]/20' : 'text-neutral-500 hover:bg-neutral-50 bg-white border border-neutral-200'}`}
                                                >
                                                    {page}
                                                </button>
                                            )
