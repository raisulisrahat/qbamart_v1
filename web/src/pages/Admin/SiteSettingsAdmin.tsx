    ...
    <div className="max-w-5xl mx-auto space-y-10 animate-in fade-in slide-in-from-bottom-2 duration-500">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button 
          ...
          className="flex items-center justify-center space-x-2 px-8 py-4 bg-[#5173FB] text-white rounded-2xl font-bold shadow-xl shadow-[#5173FB]/20 hover:bg-[#3a5bd9] transition-all disabled:opacity-70 min-w-[200px]"
        >
