      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3">
            ...
            >
              <div className="mb-10">
                <div className="w-16 h-16 bg-[#5173FB]/10 text-[#5173FB] rounded-2xl flex items-center justify-center mb-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="pt-6">
                  <button
                    type="submit"
                    disabled={isLoading}
                    className="w-full flex items-center justify-center py-4 bg-[#5173FB] text-white font-bold rounded-xl hover:bg-[#3a5bd9] transition-all focus:ring-4 focus:ring-[#5173FB]/30 disabled:opacity-70"
                  >
