  ...
  if (cart.length === 0) {
    return (
      <div className="max-w-[1400px] mx-auto px-4 py-32 text-center">
        ...
        >
          <div className="w-24 h-24 bg-[#5173FB]/5 rounded-full flex items-center justify-center mx-auto text-[#5173FB]">
          ...
          <Link 
            to="/products" 
            className="inline-flex items-center space-x-3 bg-[#5173FB] text-white font-bold py-4 px-10 rounded-2xl transition-all shadow-xl shadow-[#5173FB]/20 hover:bg-[#3a5bd9] hover:-translate-y-1 active:scale-95"
          >
           ...
           <div className="bg-white rounded-xl border border-neutral-100 shadow-sm p-6 space-y-6 sticky top-24">
              ...
              <div className="space-y-2">
                <Link 
                  ...
                  className={`group w-full bg-[#5173FB] hover:bg-[#3a5bd9] text-white font-bold py-3 rounded-lg text-center shadow-md transition-all flex items-center justify-center space-x-2 active:scale-[0.98] ${cart.some(i => i.stock !== undefined && i.stock <= 0) ? 'opacity-50 cursor-not-allowed bg-neutral-400' : ''}`}
                >
