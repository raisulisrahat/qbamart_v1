    ...
    if (error) {
        return (
            <div className="min-h-[70vh] flex flex-col items-center justify-center p-6 text-center space-y-6">
                ...
                <Link to="/" className="inline-flex items-center space-x-2 bg-[#5173FB] text-white px-6 py-3 rounded-xl font-bold hover:bg-[#3a5bd9] transition-colors shadow-lg">
        ...
        <div className="min-h-screen bg-[#F8F9FA] py-12">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center max-w-2xl mx-auto mb-16 space-y-4">
                    <span className="inline-flex items-center space-x-1.5 px-3.5 py-1.5 rounded-full bg-[#5173FB]/10 text-[#5173FB] text-xs font-bold uppercase tracking-wider">
                ...
                {activeFunnels.length === 0 ? (
                    ...
                    >
                        ...
                        <Link
                            to="/products"
                            className="inline-flex items-center space-x-2 bg-[#5173FB] text-white px-6 py-3 rounded-xl font-bold hover:bg-[#3a5bd9] transition-colors shadow-lg shadow-[#5173FB]/15"
                        >
                                ...
                                >
                                    ...
                                    <div className="p-6 flex flex-col flex-grow space-y-4">
                                        ...
                                        <div className="flex items-center gap-2 flex-wrap">
                                            {discount > 0 && (
                                                <span className="inline-flex items-center space-x-1 bg-[#5173FB] text-white text-xs font-black px-3 py-1 rounded-full shadow-sm">
                                        ...
                                        <Link
                                            to={`/offer/${funnel.slug}`}
                                            className="w-full bg-[#5173FB] hover:bg-neutral-950 text-white py-3.5 rounded-2xl font-black uppercase tracking-wider text-xs shadow-lg shadow-[#5173FB]/10 hover:shadow-xl hover:shadow-black/10 transition-all duration-300 flex items-center justify-center space-x-2 mt-auto"
                                        >
