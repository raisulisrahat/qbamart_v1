  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden select-none">
        <div className="absolute top-[-10%] right-[-10%] w-[400px] h-[400px] bg-[#5173FB]/5 rounded-full blur-[100px] opacity-40" />
      ...
      <section className="relative pt-16 pb-12 px-4 overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-24">
            ...
            >
              <div className="inline-flex items-center space-x-2 bg-[#5173FB]/5 px-3 py-1.5 rounded-full text-[#5173FB] font-bold text-[9px] uppercase tracking-[0.2em] border border-[#5173FB]/10">
              ...
              <div className="bg-white border border-neutral-100 p-6 md:p-10 rounded-[40px] shadow-[0_30px_80px_-20px_rgba(0,0,0,0.06)] relative overflow-hidden group">
                ...
                <div className="relative z-10 text-center space-y-8">
                  <div className="flex flex-col items-center gap-1.5">
                    <div className="w-6 h-[1px] bg-[#5173FB]/20" />
                        ...
                        <div className="space-y-2">
                           ...
                           <div className="h-1 w-full bg-neutral-50 rounded-full overflow-hidden">
                              <motion.div 
                                ...
                                className="h-full bg-[#5173FB] rounded-full"
                              />
                           </div>
                        </div>
                      </div>
