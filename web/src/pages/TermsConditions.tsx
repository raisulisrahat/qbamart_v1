...
const TermsConditions = () => {
  return (
    <div className="bg-white min-h-screen">
      <SEO title="Terms & Conditions" description="Read Qbamart's terms and conditions of use." />
      ...
      <div className="max-w-[800px] mx-auto px-6 py-20 prose prose-neutral prose-brand">
        ...
        <section className="mb-12">
          ...
          <p className="text-neutral-600 leading-relaxed mb-4">
            We are Qbamart ("Company," "we," "us," "our"), a company registered in Bangladesh at Mirpur-1, Dhaka 1206. We operate the website https://Qbamart.com/ (the "Site"), as well as any other related products and services that refer or link to these legal terms.
          </p>
          <p className="text-neutral-600 leading-relaxed">
            These Legal Terms constitute a legally binding agreement made between you and Qbamart, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="text-neutral-600 leading-relaxed">
            These Legal Terms shall be governed by and defined following the laws of Bangladesh. Qbamart and yourself irrevocably consent that the courts of Bangladesh shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these Legal Terms.
          </p>
        </section>
