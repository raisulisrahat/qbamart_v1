...
const BlogDetail = () => {
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-[#FAF9F6]">
        <div className="relative flex items-center justify-center">
          ...
          <div className="absolute w-8 h-8 border border-neutral-100 rounded-full bg-[#5173FB]/5 animate-ping"></div>
        </div>
  ...
  if (error || !post) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-[#FAF9F6] px-6 text-center">
        ...
        <Link to="/blogs" className="px-8 py-3.5 bg-zinc-900 text-white hover:bg-[#5173FB] rounded-full font-black text-[10px] uppercase tracking-widest shadow-xl shadow-zinc-950/10 hover:shadow-[#5173FB]/20 transition-all duration-300">
          Back to Journal
        </Link>
      </div>
    );
  ...
  return (
    <div className="bg-[#FAF9F6] min-h-screen pb-32 font-sans selection:bg-[#5173FB]/10 selection:text-[#5173FB] overflow-x-hidden">
      <SEO 
        title={post.title} 
      ...
      <div className="max-w-4xl mx-auto px-6 py-8 md:py-10 flex items-center justify-between border-b border-zinc-200/50">
        ...
        >
          <div className="w-9 h-9 rounded-full bg-white border border-zinc-100 flex items-center justify-center group-hover:bg-[#5173FB]/5 group-hover:border-[#5173FB]/15 transition-all">
            <ChevronLeft size={16} />
          </div>
      ...
      <div className="max-w-6xl mx-auto px-6 pt-12 md:pt-16">
        ...
        <div className="mt-16 pt-12 border-t border-zinc-200/50 flex flex-col sm:flex-row items-center justify-between gap-8">
          ...
          <div className="flex items-center space-x-4 bg-white px-6 py-4 rounded-3xl border border-zinc-100 shadow-sm">
            <div className="w-10 h-10 rounded-full bg-[#5173FB]/5 overflow-hidden flex items-center justify-center border border-[#5173FB]/10">
