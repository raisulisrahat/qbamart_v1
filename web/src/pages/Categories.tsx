                    ...
                    >
                        ...
                        >
                            ...
                            <div className="px-3 py-4 flex items-center justify-between">
                                ...
                                <div className="w-7 h-7 rounded-full bg-neutral-50 flex items-center justify-center text-neutral-400 group-hover:bg-[#5173FB] group-hover:text-white transition-all duration-300">
                                    <ArrowRight size={12} />
                                </div>
                            </div>
                        </Link>
