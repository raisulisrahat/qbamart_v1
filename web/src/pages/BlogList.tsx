    ...
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center bg-white">
        <div className="relative flex items-center justify-center">
          ...
          <div className="absolute w-6 h-6 border border-neutral-100 rounded-full bg-[#5173FB]/5 animate-ping"></div>
        </div>
              ...
              <div className="lg:col-span-5 p-8 md:p-12 lg:p-14 flex flex-col justify-center">
                ...
                <div className="flex items-center justify-between pt-6 border-t border-neutral-50">
                  <Link 
                    ...
                    className="inline-flex items-center gap-2 px-6 py-3 bg-neutral-900 text-white rounded-full text-[10px] font-black uppercase tracking-widest hover:bg-[#5173FB] shadow-lg shadow-neutral-950/10 hover:shadow-[#5173FB]/20 active:scale-95 transition-all duration-300"
                  >
