        ...
        <div className="flex justify-between items-center h-16 md:h-18">
          ...
          <div className="hidden md:flex items-center space-x-2 lg:space-x-5">
            ...
            >
              ...
              {cartCount > 0 && (
                <span className="absolute top-1 right-1 w-4 h-4 bg-[#5173FB] text-white text-[10px] font-bold flex items-center justify-center rounded-full shadow-sm">
                  {cartCount}
                </span>
              )}
            </button>
                    ...
                    <div className="space-y-5">
                      ...
                      <form onSubmit={loginStep === 'phone' ? handleContinue : handleMiniLogin} className="space-y-4">
                        ...
                        <button 
                          ...
                          className="w-full flex items-center justify-center space-x-2 bg-[#5173FB] text-white py-4 rounded-xl font-bold text-sm hover:bg-[#3a5bd9] transition-all shadow-lg shadow-red-700/10 active:scale-95 disabled:opacity-70 disabled:cursor-not-allowed"
                        >
                          {isMiniLoading ? (
                              ...
                              >
                                <div className="flex flex-col py-1 pb-3 px-5 space-y-0.5">
                                  {subCategoriesMap[category.id].map((sub) => (
                                    ...
                                    >
                                      <div className="w-1 h-1 rounded-full bg-neutral-200 group-hover:bg-[#5173FB] transition-colors" />
                                      <span>{sub.name}</span>
                                    </Link>
                                  ))}
