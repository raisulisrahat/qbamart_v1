                            ...
                            <div className="flex items-center gap-3 w-full sm:w-auto">
                                ...
                                {selectedReview.is_approved ? (
                                    ...
                                    <button 
                                        ...
                                        className="flex-1 sm:flex-none px-8 py-2.5 bg-[#5173FB] text-white rounded-xl text-xs font-bold uppercase tracking-widest hover:bg-black transition-all active:scale-95 shadow-lg shadow-red-700/20"
                                    >
                                        Approve Review
                                    </button>
                                )}
