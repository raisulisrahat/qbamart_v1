                            ...
                            <div className="flex bg-zinc-100 p-1 rounded-lg border border-zinc-200 shadow-sm">
                                {[
                                    ...
                                    <button
                                        ...
                                        className={`px-4 py-1.5 rounded-md text-[10px] font-bold uppercase tracking-widest transition-all ${activeTab === tab.id ? 'bg-[#5173FB] text-white shadow-sm' : 'text-zinc-400 hover:text-zinc-600'}`}
                                    >
                                        {tab.label}
                                    </button>
                                ))}
                            ...
                            {selectedIds.length > 0 && (
                                <div className="flex items-center gap-2 animate-in slide-in-from-right-4 duration-300">
                                    ...
                                    <button 
                                        ...
                                        className="px-3 py-1.5 bg-[#5173FB]/10 text-[#5173FB] rounded-lg text-[10px] font-bold uppercase tracking-widest hover:bg-[#5173FB]/20 transition-all"
                                    >
                                        Export
                                    </button>
                                    <button 
                                        ...
                                        {activeTab === 'parents' || activeTab === 'subcategories' ? (
                                            <>
                                                <td className="px-6 py-4 hidden sm:table-cell">
                                                    <span className={`inline-flex px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-widest border ${item.parent ? 'bg-zinc-50 text-zinc-400 border-zinc-100' : 'bg-[#5173FB] text-white border-[#5173FB]'}`}>
