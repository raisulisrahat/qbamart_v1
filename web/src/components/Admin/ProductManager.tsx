            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 mb-8">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <button 
                        ...
                        className="flex items-center gap-2 px-4 py-2 bg-[#5173FB] text-white rounded-lg text-sm font-semibold hover:bg-zinc-800 transition-all active:scale-95 shadow-lg shadow-zinc-900/10"
                    >
                ...
                <div className="px-6 py-4 border-b border-zinc-100 flex flex-col sm:flex-row justify-between items-center gap-4 bg-zinc-50/50">
                    ...
                    {selectedIds.length > 0 && (
                        <div className="flex items-center gap-2 animate-in slide-in-from-right-4 duration-300">
                            ...
                            <button onClick={handleBulkExport} className="px-3 py-1.5 bg-[#5173FB]/10 text-[#5173FB] rounded-lg text-xs font-semibold hover:bg-zinc-200 transition-all">Export</button>
