        ...
        <div className="animate-in fade-in duration-500">
            ...
            <div className="flex flex-row justify-between items-center gap-4 mb-8">
                ...
                <button 
                    ...
                    className="flex items-center gap-2 px-3 sm:px-5 py-2 bg-[#5173FB] text-white rounded-lg text-[10px] sm:text-xs font-bold uppercase tracking-widest hover:bg-black transition-all shadow-lg shadow-zinc-900/10 active:scale-95 shrink-0 whitespace-nowrap"
                >
