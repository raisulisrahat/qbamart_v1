                                    ...
                                    >
                                        ...
                                        <div className="flex items-center gap-1 border-r border-zinc-800 pr-2">
                                            {['25%', '50%', '75%', '100%'].map(pct => (
                                                <button
                                                    ...
                                                    className="px-2 py-1 text-[9px] font-black tracking-wider uppercase bg-zinc-900 border border-zinc-800 hover:bg-[#5173FB] hover:border-[#5173FB] rounded-md transition-all active:scale-95 text-white cursor-pointer"
                                                >
                                                    {pct}
                                                </button>
                                            ))}
                                        ...
                                        <div className="flex items-center gap-1 border-r border-zinc-800 pr-2">
                                            <button
                                                ...
                                                title="Align Left"
                                                className="p-1.5 bg-zinc-900 border border-zinc-800 hover:bg-[#5173FB] hover:border-[#5173FB] rounded-md transition-all active:scale-95 text-zinc-300 hover:text-white cursor-pointer"
                                            >
                                                <AlignLeft size={12} />
                                            </button>
                                            <button
                            ...
                            >
                                {imagePreview ? (
                                    ...
                                    <div className="flex flex-col items-center gap-2 group-hover:scale-110 transition-transform">
                                        <div className="p-2 bg-zinc-100 rounded-lg text-zinc-400 group-hover:bg-[#5173FB]/10 group-hover:text-[#5173FB] transition-all">
                                            <ImageIcon size={18} />
                                        </div>
