        ...
        return (
            <div className="flex flex-col h-64 items-center justify-center gap-4 text-center max-w-md mx-auto">
                ...
                <button 
                    ...
                    className="px-4 py-2 bg-[#5173FB] text-white rounded-lg text-sm font-medium hover:bg-[#3a5bd9] transition-all"
                >
                    Retry Connection
                </button>
            </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <button 
                                            ...
                                            className="p-3 bg-[#5173FB] text-white rounded-xl hover:bg-black transition-all active:scale-95"
                                        >
                                            <Copy size={16} />
                                        </button>
                                    </div>
                ...
                <div className={`fixed bottom-8 left-1/2 -translate-x-1/2 z-[50] flex items-center justify-between bg-white/90 backdrop-blur-xl border border-zinc-200 p-4 rounded-2xl shadow-2xl transition-all duration-300 w-[90%] max-w-xl ${isDirty() ? 'translate-y-0 opacity-100' : 'translate-y-12 opacity-0 pointer-events-none'}`}>
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <button
                            type="submit"
                            disabled={saving}
                            className="bg-[#5173FB] text-white px-6 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest shadow-xl shadow-zinc-900/10 active:scale-95 transition-all flex items-center gap-2"
                        >
