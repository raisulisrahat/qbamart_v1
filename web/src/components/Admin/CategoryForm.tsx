                        ...
                        <div className="space-y-2">
                            <div className="flex justify-between items-center ml-1">
                                ...
                                <button 
                                    ...
                                    className="p-1 bg-zinc-100 text-zinc-600 rounded-md hover:bg-[#5173FB] hover:text-white transition-all active:scale-90"
                                >
                                    <Plus size={14} />
                                </button>
                            </div>
                        ...
                        <form onSubmit={handleQuickAdd} className="p-8 space-y-6">
                            ...
                            <div className="flex gap-3 pt-4">
                                ...
                                <button
                                    type="submit"
                                    disabled={loading}
                                    className="flex-1 px-6 py-3 bg-[#5173FB] text-white rounded-2xl text-[10px] font-bold uppercase tracking-widest hover:bg-black transition-all shadow-lg shadow-[#5173FB]/10 active:scale-95"
                                >
