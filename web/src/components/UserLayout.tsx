            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-3 mt-8">
                ...
                <button
                  ...
                  className="w-full sm:w-1/2 py-4 bg-[#5173FB] hover:bg-[#3a5bd9] text-white font-extrabold rounded-2xl transition-all shadow-lg shadow-[#5173FB]/20 active:scale-[0.97] flex items-center justify-center gap-2 group"
                >
