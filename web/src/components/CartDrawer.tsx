          ...
          >
            ...
            <div className="flex items-center justify-between p-6 border-b border-neutral-100">
              <div className="flex items-center space-x-3">
                <div className="p-2 bg-[#5173FB]/10 rounded-xl text-[#5173FB]">
              ...
              <div className="p-6 border-t border-neutral-100 space-y-4 bg-neutral-50/50">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <Link 
                    ...
                    className={`flex items-center justify-center space-x-2 py-3.5 bg-[#5173FB] text-white rounded-xl font-bold text-sm shadow-lg shadow-red-700/10 hover:bg-[#3a5bd9] transition-all active:scale-95 ${cart.some(i => i.stock !== undefined && i.stock <= 0) ? 'opacity-50 cursor-not-allowed bg-neutral-400' : ''}`}
                  >
                    <span>Checkout</span>
