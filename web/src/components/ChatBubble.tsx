...
const ChatBubble: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-35 right-6 md:bottom-6 md:right-6 z-[9999] flex flex-col items-end gap-4 pointer-events-none">
      <AnimatePresence>
        {isOpen && (
          <motion.div
          ...
          >
            {settings?.support_phone && (
              <a
                ...
                className="flex items-center gap-3 px-3 py-2 bg-white/80 backdrop-blur-md border border-white/20 shadow-xl rounded-full group hover:bg-[#5173FB] transition-all duration-300 transform hover:-translate-x-1"
              >
                <div className="w-10 h-10 bg-[#5173FB] text-white rounded-full flex items-center justify-center group-hover:bg-white group-hover:text-[#5173FB] transition-colors shadow-sm">
