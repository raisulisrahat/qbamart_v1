    ...
    return (
        <>
            ...
            {tickerNotices.length > 0 && (
                <div className="bg-[#5173FB] text-white py-2 overflow-hidden relative z-50">
                    ...
                    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 sm:p-6">
                        ...
                        >
                            ...
                            <div className={`flex-1 p-8 flex flex-col justify-center ${!activePopup.image ? 'items-center text-center' : ''}`}>
                                <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#5173FB]/10 text-[#5173FB] rounded-full mb-4">
                                ...
                                {activePopup.button_link && (
                                    <a 
                                        ...
                                        onClick={closePopup}
                                        className="inline-flex items-center justify-center gap-3 px-8 py-4 bg-zinc-900 text-white rounded-2xl text-xs font-black uppercase tracking-widest hover:bg-[#5173FB] hover:shadow-xl hover:shadow-[#5173FB]/20 transition-all active:scale-95 group"
                                    >
