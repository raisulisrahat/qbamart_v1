...
from .views import (
    ...
    MediaManagerView, SecurityAuditView, BkashCallbackView, PageSeoViewSet, CourierWebhookView
)
...
router.register(r'subcategories', CategoryViewSet, basename='subcategory')
