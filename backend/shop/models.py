...
class SiteSettings(models.Model):
    ...
    footer_description = models.TextField(blank=True, null=True, help_text="Footer Description")
    footer_address = models.TextField(blank=True, null=True, help_text="Footer Address info")
    ...
    tiktok_pixel_id = models.CharField(max_length=50, blank=True, null=True, help_text="TikTok Pixel ID")
    tiktok_events_api_token = models.TextField(blank=True, null=True, help_text="TikTok Events API Access Token")
    tiktok_test_event_code = models.CharField(max_length=100, blank=True, null=True, help_text="TikTok Events API Test Event Code")
    tiktok_enable_advanced_matching = models.BooleanField(default=False, help_text="Enable TikTok Advanced Matching")
    google_ads_id = models.CharField(max_length=50, blank=True, null=True, help_text="Google Ads Conversion ID (gtag.js) e.g. AW-XXXXXXX")
    google_ads_conversion_label = models.CharField(max_length=255, blank=True, null=True, help_text="Google Ads Conversion Label")
    google_ads_merchant_center_id = models.CharField(max_length=50, blank=True, null=True, help_text="Google Merchant Center ID")
    google_ads_business_vertical = models.CharField(max_length=50, default='retail', blank=True, null=True, help_text="Google Ads Business Vertical")
    pinterest_tag_id = models.CharField(max_length=50, blank=True, null=True, help_text="Pinterest Tag ID")
    pinterest_ad_account_id = models.CharField(max_length=100, blank=True, null=True, help_text="Pinterest Ad Account ID")
    pinterest_capi_token = models.TextField(blank=True, null=True, help_text="Pinterest Conversions API Token")
    pinterest_enhanced_match = models.BooleanField(default=False, help_text="Enable Pinterest Enhanced Match")
    pinterest_advanced_matching = models.BooleanField(default=False, help_text="Enable Pinterest Advanced Matching")
    bing_uet_id = models.CharField(max_length=50, blank=True, null=True, help_text="Bing UET Tag ID")
    bing_uet_enhanced_conversions = models.BooleanField(default=False, help_text="Enable Bing UET Enhanced Conversions")
    microsoft_clarity_project_id = models.CharField(max_length=50, blank=True, null=True, help_text="Microsoft Clarity Project ID")
    reddit_tag_id = models.CharField(max_length=50, blank=True, null=True, help_text="Reddit Tag ID")
    other_pixel_id = models.CharField(max_length=255, blank=True, null=True, help_text="Other / Custom Pixel ID")
    
    # Toggles for each tracking tool
    enable_facebook_pixel = models.BooleanField(default=True, help_text="Enable/Disable Facebook Pixel")
    enable_google_analytics = models.BooleanField(default=True, help_text="Enable/Disable Google Analytics")
    enable_measurement_protocol = models.BooleanField(default=False, help_text="Enable Measurement Protocol")
    google_analytics_api_secret = models.CharField(max_length=255, blank=True, null=True, help_text="Measurement Protocol API Secret")
    enable_server_container = models.BooleanField(default=False, help_text="Enable Server Container URL")
    server_container_url = models.CharField(max_length=255, blank=True, null=True, help_text="Server Container URL")
    transport_url = models.CharField(max_length=255, blank=True, null=True, help_text="Transport URL")
    enable_google_tag_manager = models.BooleanField(default=True, help_text="Enable/Disable Google Tag Manager")
    enable_tiktok_pixel = models.BooleanField(default=True, help_text="Enable/Disable TikTok Pixel")
    enable_google_ads = models.BooleanField(default=True, help_text="Enable/Disable Google Ads Tag")
    enable_pinterest_tag = models.BooleanField(default=True, help_text="Enable/Disable Pinterest Tag")
    enable_bing_uet = models.BooleanField(default=True, help_text="Enable/Disable Bing UET Tag")
    enable_microsoft_clarity = models.BooleanField(default=True, help_text="Enable/Disable Microsoft Clarity")
    enable_reddit_tag = models.BooleanField(default=True, help_text="Enable/Disable Reddit Tag")
    enable_other_pixel = models.BooleanField(default=False, help_text="Enable Other / Custom Pixel")
    
    custom_head_script = models.TextField(blank=True, null=True, help_text="Custom Head Script / HTML")
    enable_custom_head_script = models.BooleanField(default=False, help_text="Enable Custom Head Script")
